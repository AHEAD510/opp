...
// Re-try NEWS Swiper init after all scripts are loaded.
// This fixes cases where common.js is loaded before swiper-bundle.min.js.
window.addEventListener("load", () => {
  try { initNewsSwiper(); } catch (e) {}
});